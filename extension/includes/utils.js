 ...
 * @param {ArrayBuffer} certificateDer DER encoded X.509 certificate
 * @return {Object} certificate details
 */
export function decodeDerCertificate(certificateDer) {
	...
	let expirationDate = "Not defined"
	if (certificate.notAfter) {
		expirationDate = certificate.notAfter.value.toUTCString()
	}
